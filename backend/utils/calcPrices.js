...
// for fixing an issue with type coercion of strings to numbers. addDecimals function expects a number and returns a string, so it is not correct to call it passing a string as the argument.
